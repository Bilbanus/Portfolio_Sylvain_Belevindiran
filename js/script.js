const sections = {
    ...
    communication: {
        projects: [
            ...
            {
                id: 12,
                title: 'SAE 202 – Kanoguti Experience',
            ...
            {
                id: 15,
                title: 'Charte graphique SAE 202',
                description: 'Création d’une charte graphique complète...',
                image: '../img/coeur.png',
                link: 'https://www.figma.com/design/ujsU5Jvxry6Kl4zThcLjG8/Untitled?node-id=0-1&p=f&t=ye0Jy2vjMJRDNrJL-0'
            }
        ]
    }
};
...
function openModal(project) {
    ...
    document.getElementById('modal-icon').innerHTML = `<img src="${project.image}" alt="${project.title}">`;
